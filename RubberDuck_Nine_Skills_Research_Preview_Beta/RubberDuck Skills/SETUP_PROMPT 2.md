# RubberDuck Setup Prompt

Use this prompt at the start of a repo session after installing the RubberDuck skills. It activates the Skill Advisor workflow and tells the agent where to find the installed advisor instructions.
...
For persistent repo behavior, add the relevant platform snippet:
